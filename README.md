...
A production-ready **Multi-Agent LLM System** to overcome hallucinations built with LangChain and LangGraph, featuring **Retrieval-Augmented Generation (RAG)**, **self-reflection**, **ReAct reasoning**, and comprehensive **guardrails**, **Cost Budget Control**. Designed for scalable, reliable AI-powered document Q&A.
